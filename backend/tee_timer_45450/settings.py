"""
Django settings for tee_timer_45450 project.
...
ROOT_URLCONF = 'tee_timer_45450.urls'
...
WSGI_APPLICATION = 'tee_timer_45450.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tee_timer_45450 API",
    "DESCRIPTION": "API documentation for tee_timer_45450 App",
    "VERSION": "v1",
}
